...
function initCategories() {
  // Support both old (.cat-card) and new (.cat-card-new) category buttons
  document.querySelectorAll(".cat-card, .cat-card-new").forEach(btn => {
    btn.addEventListener("click", () => {
      document.querySelectorAll(".cat-card, .cat-card-new").forEach(b => b.classList.remove("active"));
...
window.sendOrderWA = async function() {
  ...
  renderCartBadge();
  closeOrderModal();
  showToast("✅ Pedido enviado. Te contactaremos pronto 🔥", 4000);
};
