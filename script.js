...
function renderCard(product) {
  ...
  const hasOffer = product.salePrice && product.salePrice > 0 && product.salePrice < product.price;
...
function openProductModal(fbKey = null) {
  ...
  // Reset form
  ["pName","pPrice","pOriginalPrice","pEmoji","pDesc","pImageUrl","pSalePrice"].forEach(id => {
