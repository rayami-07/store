...
function renderOrdersTable() {
  ...
  if (!tbody) return;
  document.getElementById("oStatTotal").textContent     = allOrders.length;
  ...
  const filtered = ordersFilter==="todos" ? allOrders : allOrders.filter(o=>o.status===ordersFilter);
  if (!filtered.length) { tbody.innerHTML=""; empty.style.display="block"; return; }
  empty.style.display="none";
  const statusMap = {
    pendiente: `<span class="pub-badge pub-wait">⏳ Pendiente pago</span>`,
