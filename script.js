...
function showAdmin() {
  ...
  renderAdminTable();
  renderAdminStats();
  renderAdminSellers(); // ya tenemos allSellers cargado
...
window.switchAdminTab = function(tab) {
  const panels = { products:"adminPanelProducts", sellers:"adminPanelSellers", sellerProducts:"adminPanelSellerProducts" };
  const tabs   = { products:"adminTabProducts",   sellers:"adminTabSellers",   sellerProducts:"adminTabSellerProducts" };
